...
"""
#******This script to apply Hybrid linear regression with KNN on Matlab dataset****
"""
import pandas as pd
...
from sklearn.metrics import mean_squared_error, r2_score, SCORERS, mean_absolute_error
...
selection = SelectKBest(f_regression, k=5).fit(x,y)
...
plt.title(' Predictions vs Actual Values at (n-neighbors=1, K=5)')
